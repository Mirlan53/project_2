...
from .views import student_list, student_detail, student_create, teacher_create, student_update, student_delete, teachers_students
...
urlpatterns = [
	...
	path('teachers_students/<int:teacher_id>', teachers_students, name='teachers_students'),
