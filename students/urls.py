...
from .views import student_list, student_detail, student_create, teacher_create, student_update, student_delete, student_teacher
...
urlpatterns = [
	...
	path('student_teacher/<int:student_id>', student_teacher, name='student_teacher'),
